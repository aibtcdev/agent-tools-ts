...
(define-public (create-proposal (proposal <proposal-trait>) (token <ft-trait>))
  (let
    ...
    (asserts! (is-none (contract-call? 'ST1TZE9ZY61FYR7YM9BR0543XKX9YG5TR9017R4WJ.win2-base-dao executed-at proposal)) ERR_PROPOSAL_ALREADY_EXECUTED)
...
(define-public (conclude-proposal (proposal <proposal-trait>) (treasury <treasury-trait>) (token <ft-trait>))
  (let
    ...
    (and votePassed (try! (contract-call? 'ST1TZE9ZY61FYR7YM9BR0543XKX9YG5TR9017R4WJ.win2-base-dao execute proposal tx-sender)))
    ;; return the result
    (ok votePassed)
  )
)
...
(define-private (is-dao-or-extension)
  (ok (asserts! (or (is-eq tx-sender 'ST1TZE9ZY61FYR7YM9BR0543XKX9YG5TR9017R4WJ.win2-base-dao)
    (contract-call? 'ST1TZE9ZY61FYR7YM9BR0543XKX9YG5TR9017R4WJ.win2-base-dao is-extension contract-caller)) ERR_NOT_DAO_OR_EXTENSION
  ))
)