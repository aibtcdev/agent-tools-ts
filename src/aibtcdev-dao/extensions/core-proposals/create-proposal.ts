...
async function main() {
  ...
  if (
    ...
    console.log(
      "Usage: bun run create-new-core-proposal.ts <daoCoreProposalExtensionContract> <newProposalContract>"
    );
    console.log(
      "- e.g. bun run create-new-core-proposal.ts ST35K818S3K2GSNEBC3M35GA3W8Q7X72KF4RVM3QA.wed-core-proposals ST35K818S3K2GSNEBC3M35GA3W8Q7X72KF4RVM3QA.aibtc-base-bootstrap-initialization"
    );
