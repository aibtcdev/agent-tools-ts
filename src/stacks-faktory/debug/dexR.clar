;; 395571c61c9fb11bd2e331909d482a9c1e4e5f1aea6b1d0245796797046bbf33
      ...
      (define-constant DEX-TOKEN 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simpl1-faktory)
      ...
      (define-public (buy (ft <faktory-token>) (ubtc uint))
        (begin
          ...
          (try! (contract-call? 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.sbtc-token 
                      transfer pre-fee tx-sender 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simpl1-pre-faktory none))
          (try! (as-contract (contract-call? 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simpl1-pre-faktory create-fees-receipt pre-fee)))        
          (try! (contract-call? 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.sbtc-token 
            ...
            (if (>= new-stx TARGET_STX)
                ...
                (try! (as-contract (contract-call? ft transfer originator-amount tx-sender ORIGINATOR none)))
                  (try! (as-contract 
                         (contract-call? 
                           'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.xyk-core-v-1-2
                               create-pool 
                               'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.xyk-pool-sbtc-simpl1-v-1-1
                  ...
                  (try! (as-contract (contract-call? 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simpl1-pre-faktory toggle-bonded)))
      ...
      (define-public (open-market) 
        (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simpl1-pre-faktory is-market-open))))
        ...
        (begin
          ...
          (var-set stx-balance DEX-AMOUNT)
            (print { 
                ...
                poolName: 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.xyk-pool-sbtc-simpl1-v-1-1
           })
          (ok true))