;; c9b64ae3f3c52020e3eb20962e08d2b460be68bb6c3ae647134f32f0610c1ec7
...
;; Token, Dex and sBTC
(define-constant TOKEN-DAO 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simpl1-faktory) ;; param
(define-constant DEX-DAO 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simpl1-faktory-dex) ;; param
...
(define-read-only (is-governance-active)
  ...
  (define-private (initialize-token-distribution)
      (begin
          ...
          ;; missing Rapha initialize stx var-set  stx-balance u0
          (print {
