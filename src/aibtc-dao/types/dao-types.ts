...
const mainnetTraits: KnownTraits = {
  ...
  DAO_TIMED_VAULT:
    "SP29CK9990DQGE9RGTT1VEQTTYH8KY4E3JE5XP4EC.aibtc-dao-traits-v2.timed-vault",
  DAO_CHARTER:
...
const testnetTraits: KnownTraits = {
  ...
  BITFLOW_SIP010:
    "STTWD9SPRQVD3P733V89SV0P8RZRZNQADG034F0A.sip-010-trait-ft-standard.sip-010-trait",
  DAO_BASE:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-v2.aibtc-base-dao",
  DAO_PROPOSAL:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.proposal",
  DAO_EXTENSION:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.extension",
  DAO_ACTION:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.action",
  DAO_ACTION_PROPOSALS:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.action-proposals",
  DAO_TIMED_VAULT:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.timed-vault",
  DAO_CHARTER:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.charter",
  DAO_CORE_PROPOSALS:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.core-proposals",
  DAO_INVOICES:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.invoices",
  DAO_MESSAGING:
  ...
  DAO_TOKEN_DEX:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.faktory-dex",
  DAO_TOKEN_OWNER:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.token-owner",
  DAO_TOKEN_POOL:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.bitflow-pool",
  DAO_TREASURY:
    "ST1B1CCG03BTGDAAR49R3KM34V48P3RPAQ4P2SSJG.aibtc-dao-traits-v2.treasury",
};
...
const devnetTraits: KnownTraits = {
  ...
  DAO_TIMED_VAULT:
    "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.aibtc-dao-traits-v2.timed-vault",
  DAO_CHARTER:
...
const CONTRACT_SUBCATEGORIES = {
  BASE: ["DAO"] as const,
  ACTIONS: [
    "TIMED_VAULT_SET_ACCOUNT_HOLDER",
    "TIMED_VAULT_SET_WITHDRAWAL_AMOUNT",
    "TIMED_VAULT_SET_WITHDRAWAL_PERIOD",
