...
const usage = "Usage: bun run deposit-stx.ts <smartWalletContract> <amount>";
const usageExample =
  "Example: bun run deposit-stx.ts ST35K818S3K2GSNEBC3M35GA3W8Q7X72KF4RVM3QA.aibtc-user-agent-smart-wallet 1000000";
